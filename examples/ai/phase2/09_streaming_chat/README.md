...
```bash
env -u OPENAI_API_KEY go run ./examples/ai/phase2/09_streaming_chat
```
...
go run ./examples/ai/phase2/09_streaming_chat
```

## 验证方式

```bash
gofmt -w examples/ai/phase2/09_streaming_chat/*.go
go test -timeout=60s ./examples/ai/phase2/09_streaming_chat
go vet ./examples/ai/phase2/09_streaming_chat
```
