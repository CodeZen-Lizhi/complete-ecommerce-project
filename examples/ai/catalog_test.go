...
var requiredExerciseSymbols = map[string][]string{
	...
	"phase3/02_document_loading_metadata":      {"documentLoader", "validateDocumentPath", "normalizeDocument"},
	"phase3/03_chunking_strategies":            {"chunker", "buildParentChildChunks"},
	"phase3/04_vector_index_and_retrieval":     {"indexer", "retriever", "validateIndexBatch"},
	"phase3/05_hnsw_tuning":                    {"hnswIndex", "evaluateHNSW"},
	"phase3/06_parent_child_retrieval":         {"childRetriever", "parentStore", "expandParents"},
	"phase3/07_hybrid_search_rrf":              {"denseRetriever", "sparseRetriever", "reciprocalRankFusion"},
	"phase3/08_query_rewrite_and_filter":       {"queryRewriter", "filteredRetriever", "validateQueryFilter"},
	"phase3/09_rerank":                         {"reranker", "validateRerankResults"},
	"phase3/10_context_budget_and_citations":   {"tokenCounter", "selectContext"},
	"phase3/11_index_lifecycle":                {"documentStateStore", "vectorIndex", "runImport"},
	"phase3/12_rag_evaluation":                 {"recallAtK", "reciprocalRank", "summarizeRAGEvaluation"},
	"phase4/01_local_readonly_tool":            {"readonlyTool", "toolExecutor", "validateToolInfo"},
	...
	"phase4/05_multi_tool_orchestration":       {"toolRegistry", "modelTurn", "runToolLoop"},
	...
	"phase5/01_chain_workflow":                 {"chainNode", "compiledChain", "buildChain"},
	"phase5/02_graph_routing":                  {"classifyRoute", "compiledGraph", "buildRoutingGraph"},
	"phase5/03_react_agent":                    {"reactModel", "reactToolsNode", "runReAct"},
	...
	"phase5/06_interrupt_checkpoint_resume":    {"checkpointStore", "resumeFromCheckpoint"},
	...
	"phase6/03_answer_quality_checks":          {"validateCitations", "evaluateFacts"},
	...
	"phase7/04_end_to_end_tracing":             {"tracer", "span", "tracePipeline"},
	...
	"phase7/07_health_gray_release_rollback":   {"validateHealth", "evaluateRollout"},
